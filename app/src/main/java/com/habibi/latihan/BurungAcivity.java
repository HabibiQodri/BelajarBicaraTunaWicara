...
public class BurungAcivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vidioAyah.loadUrl("file:///android_asset/kata_benda/binatang/burung.html");
        audioAyah = MediaPlayer.create(BurungAcivity.this,R.raw.ayah);
    }
